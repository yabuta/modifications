  ...
  m_authUsers(catalog, this, path + "/" + "authUsers"), m_authGroups(catalog, this, path + "/" + "authGroups"), m_authPrograms(catalog, this, path + "/" + "authPrograms"), m_statements(catalog, this, path + "/" + "statements"), m_parameters(catalog, this, path + "/" + "parameters")
{
    ...
    m_fields["hasseqscans"] = value;
    m_fields["language"] = value;
...
void Procedure::update() {
    ...
    m_hasseqscans = m_fields["hasseqscans"].intValue;
    m_language = m_fields["language"].strValue.c_str();
...
bool Procedure::defaultproc() const {
...
bool Procedure::hasseqscans() const {
    return m_hasseqscans;
}

const string & Procedure::language() const {
    return m_language;
}
