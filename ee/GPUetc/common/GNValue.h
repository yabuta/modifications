...
*/
  ...
  */
  ...
  /*
    ...
    static CUDAH inline int32_t getCharLength(const char *valueChars, const size_t length) {
...
/*
    static CUDAH inline int32_t getIthCharIndex(const char *valueChars, const int64_t length, const int64_t ith) {
        if (ith <= 0) return -1;
        int32_t i = 0, j = 0;
...
/*
    static inline CUDAH const char* getIthCharPosition(const char *valueChars, const size_t length, const int32_t ith) {
        // very efficient code to count characters in UTF string and ASCII string
...
*/
  ...
  */
     ...
     */
/*
    CUDAH void setObjectValue(void* object) {
 ...
 */
 ...
 /*
inline CUDAH void NValue::serializeToTupleStorage(void *storage, const bool isInlined,
...
inline CUDAH NValue NValue::op_min(const NValue rhs) const {
    if (compare(rhs) < 0) {
        return *this;
    } else {
        return rhs;
