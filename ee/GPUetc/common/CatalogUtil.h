 ...
 */
CUDAH bool isTableExportOnly(catalog::Database const & database, int32_t tableIndex) {
 ...
 * database as a whole
 */
CUDAH bool isExportEnabledForTable(catalog::Database const & database, int32_t tableIndex) {
...
CUDAH bool isTableMaterialized(const catalog::Table &table) {
